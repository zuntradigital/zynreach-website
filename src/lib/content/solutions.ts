...
export const solutionPages: SolutionPageContent[] = [
  ...
  },
  {
    ...
    howItWorks: [
      { headline: "Get started with templates", description: "Skip configuration and launch in minutes." },
      { headline: "Automate the busywork", description: "No-code workflows replace manual admin, no engineer needed." },
      { headline: "Grow without re-platforming", description: "The same platform scales as your team does." },
    ],
    storyNote: "Illustrative example — real customer stories launch with the Customer Stories page.",
  ...
  },
  {
    ...
    howItWorks: [
      { headline: "Deploy with security built in", description: "Enterprise-grade controls from day one, not bolted on later." },
      { headline: "Standardize across regions", description: "One system of record replaces fragmented legacy tools." },
      { headline: "Scale governance as you grow", description: "Permissions, audit trails, and reporting keep pace." },
    ],
    storyNote: "Illustrative example — real customer stories launch with the Customer Stories page.",
  ...
  },
  {
    ...
    navLabel: "For Growing Businesses",
    meta: {
      h1: "Built for the stage after startup, before enterprise",
      title: "ZynReach for Growing Businesses",
      description: "Replace spreadsheets and point tools with one platform that scales as your headcount and processes do.",
    },
    hero: {
      headline: "Built for the stage after startup, before enterprise",
      subhead:
        "You've outgrown spreadsheets and disconnected tools, but you're not ready for enterprise complexity — ZynReach scales with you, not against you.",
    },
    primaryCta: { label: "Start Free Trial", href: "/trial" },
    before: {
      label: "Before ZynReach",
      body: "Growth outpaced your tools. Spreadsheets, ad-hoc processes, and five disconnected apps can't keep up with new headcount and new customers.",
    },
    after: {
      label: "With ZynReach",
      body: "One platform scales with headcount and process — no re-platforming required as you grow from 20 people to 200.",
    },
    capabilityCallouts: [
      { label: "CRM", href: "/platform/crm", description: "Structure your pipeline without slowing your team down." },
      { label: "Workflow Automation", href: "/platform/workflow-automation", description: "Codify process as you scale, without an engineer." },
      { label: "Analytics", href: "/platform/analytics", description: "Visibility that keeps pace with growth." },
    ],
    howItWorks: [
      { headline: "Migrate off spreadsheets", description: "Move pipeline and process into one structured platform." },
      { headline: "Automate as you add headcount", description: "New hires ramp on process that's already codified." },
      { headline: "Scale without re-platforming", description: "The same system carries you from 20 people to 200." },
    ],
    storyNote: "Illustrative example — real customer stories launch with the Customer Stories page.",
    relatedIntegrations: ["Email & Calendar", "Collaboration", "Billing & Payments"],
  },
  {
    slug: "mid-market",
    navLabel: "For Mid-Market",
    meta: {
      h1: "Structure and governance without enterprise overhead",
      title: "ZynReach for Mid-Market",
      description: "The process control and governance mid-sized companies need, without full enterprise complexity or procurement overhead.",
    },
    hero: {
      headline: "Structure and governance without enterprise overhead",
      subhead: "More structure than SMB tooling offers, without the procurement cycles and complexity of enterprise software.",
    },
    primaryCta: { label: "Book a Demo", href: "/demo" },
    before: {
      label: "Before ZynReach",
      body: "SMB tools stop scaling once you cross a few hundred employees, but full enterprise platforms mean months of procurement and implementation.",
    },
    after: {
      label: "With ZynReach",
      body: "Departmental structure, permissions, and reporting that match how a 200-2,000-person company actually runs — deployed in weeks, not quarters.",
    },
    capabilityCallouts: [
      { label: "Teams & Departments", href: "/platform/teams-departments", description: "Departmental structure that mirrors your org chart." },
      { label: "Workflow Automation", href: "/platform/workflow-automation", description: "Approval flows without enterprise complexity." },
      { label: "Business Intelligence", href: "/platform/business-intelligence", description: "Cross-team reporting that scales with you." },
    ],
    howItWorks: [
      { headline: "Set up departmental structure", description: "Teams, permissions, and reporting mirror your org chart." },
      { headline: "Add approval flows", description: "Governance without the overhead of enterprise procurement." },
      { headline: "Report across departments", description: "Cross-team visibility from one connected data model." },
    ],
    storyNote: "Illustrative example — real customer stories launch with the Customer Stories page.",
