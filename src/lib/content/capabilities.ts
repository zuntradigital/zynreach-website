...
export const capabilityPages: CapabilityPageContent[] = [
  ...
  },
  {
    ...
    meta: {
      h1: "Work every deal, stage by stage",
      title: "ZynReach Sales Pipeline",
      description:
        "The sales execution layer on top of CRM — deals, tasks, follow-ups, and conversion tracking in one view.",
    },
    hero: {
      headline: "Work every deal, stage by stage",
      subhead:
        "The execution layer on top of CRM — deals, tasks, and follow-ups organized so reps always know the next move, and managers always know what's actually converting.",
    },
    whoItsFor: [
      { label: "Sales Teams", href: "/solutions/sales" },
      { label: "Startups & SMBs", href: "/solutions/smb" },
    ...
    featureBlocks: [
      {
        headline: "Visual deal stages",
        description:
          "A drag-and-drop pipeline board shows every deal's stage at a glance, so reps and managers see the same picture without a status meeting.",
        proof: { stat: "1 view", label: "of every deal in motion" },
      },
      {
        headline: "Task & follow-up discipline",
        description:
          "Every deal carries its next-step task automatically, so nothing goes quiet waiting on someone to remember to follow up.",
        proof: { stat: "0", label: "deals without a next step" },
      },
      {
        headline: "Conversion tracking built in",
        description:
          "Stage-to-stage conversion rates update automatically, showing exactly where deals stall before the quarter is over.",
        proof: { stat: "+18%", label: "stage-to-stage conversion lift" },
      },
      {
        headline: "Deal aging alerts",
        description:
          "Deals that sit too long in a stage get flagged automatically, so at-risk pipeline surfaces before it's too late to save.",
        proof: { stat: "3 days", label: "faster stalled-deal detection" },
      },
    ],
    howItWorks: [
      { headline: "Add a deal", description: "Deals enter the pipeline from a lead, a form, or a manual add." },
      { headline: "Assign owner and stage", description: "Every deal gets a clear owner and a current stage from day one." },
      { headline: "Tasks keep it moving", description: "Follow-up tasks generate automatically so deals don't go stale." },
      { headline: "Conversion tracks itself", description: "Stage-by-stage conversion updates live as deals move forward." },
    ],
    comparison: {
      title: "Sales Pipeline vs. tracking deals by memory",
      statusQuo:
        "Deal status lives in reps' heads and inboxes — managers find out a deal stalled only when it's already too late.",
      withZynReach:
        "Every deal shows its stage, owner, and next step in one board, with stalled deals flagged automatically.",
    },
    relatedIntegrations: ["CRM Data", "Email & Calendar", "Analytics & BI"],
    seoKeywordCluster: "sales pipeline software, deal tracking and follow-up automation",
  },
  {
    slug: "campaigns",
    navLabel: "Campaigns",
    meta: {
      h1: "Build and launch campaigns from one place",
      title: "ZynReach Campaigns",
      description:
        "Assemble and launch multichannel campaigns from one builder, tracked against a shared audience.",
    },
    hero: {
      headline: "Build and launch campaigns from one place",
      subhead:
        "Assemble a campaign once — email, in-app, and landing pages launch together, tracked against the same audience and the same goal.",
    },
    whoItsFor: [
      { label: "Marketing Teams", href: "/solutions/marketing" },
      { label: "Agencies", href: "/solutions/agencies" },
    ...
    featureBlocks: [
      {
        headline: "One builder, every channel",
        description:
          "Assemble a campaign from reusable content blocks once, then launch it across email, in-app, and landing pages together.",
        proof: { stat: "1 build", label: "launches everywhere" },
      },
      {
        headline: "Channel orchestration",
        description:
          "Email, in-app messages, and landing pages launch in sync off one campaign timeline, instead of three separate tools.",
        proof: { stat: "3 channels", label: "one launch" },
      },
      {
        headline: "Shared audience targeting",
        description:
          "Campaigns draw on the same segments and scoring Marketing Automation already builds, so audiences never need rebuilding per channel.",
        proof: { stat: "0", label: "audiences rebuilt per channel" },
      },
      {
        headline: "Live performance tracking",
        description:
          "See opens, clicks, conversions, and pipeline impact per campaign as it happens, not after a manual export.",
        proof: { stat: "Real-time", label: "campaign performance tracking" },
      },
    ],
    howItWorks: [
      { headline: "Define the goal and audience", description: "Pick the segment and the outcome the campaign is built for." },
      { headline: "Assemble content across channels", description: "Build email, in-app, and landing page content from one workspace." },
      { headline: "Launch on schedule or trigger", description: "Send immediately, on a schedule, or off a behavioral trigger." },
      { headline: "Track results live", description: "Performance and pipeline impact update in one dashboard as the campaign runs." },
    ],
    comparison: {
      title: "Campaigns vs. building each channel separately",
      statusQuo:
        "Each channel gets built and launched separately, with its own audience export and its own results to reconcile afterward.",
      withZynReach:
        "One campaign, one audience, one launch — results roll up automatically across every channel it touched.",
    },
    relatedIntegrations: ["Email & Calendar", "Analytics & BI", "Collaboration"],
    seoKeywordCluster: "multichannel campaign builder, campaign management software",
  },
  {
    slug: "contact-360",
    navLabel: "Contact 360",
    meta: {
      h1: "One record, every touchpoint",
      title: "ZynReach Contact 360",
      description:
        "A unified contact record showing every deal, email, call, campaign, and support ticket in one view.",
    },
    hero: {
      headline: "One record, every touchpoint",
      subhead:
        "Deals, emails, calls, campaigns, and support tickets — every interaction with a contact lives on a single record, so no one starts a conversation blind.",
    },
    whoItsFor: [
      { label: "Sales Teams", href: "/solutions/sales" },
      { label: "Marketing Teams", href: "/solutions/marketing" },
    ...
    featureBlocks: [
      {
        headline: "One unified touchpoint timeline",
        description:
          "Every interaction — deal activity, emails, calls, campaign sends, support tickets — appears in one chronological timeline per contact.",
        proof: { stat: "1 timeline", label: "every touchpoint, in order" },
      },
      {
        headline: "Cross-team visibility",
        description:
          "Sales, marketing, and support all look at the same contact record, so no team is working from a partial picture.",
        proof: { stat: "0", label: "silos between teams" },
      },
      {
        headline: "Full interaction history",
        description:
          "Nothing gets lost between tools — every touch a contact has with your business is attached automatically, not manually logged.",
        proof: { stat: "100%", label: "activity captured per contact" },
      },
      {
        headline: "Instant context before any conversation",
        description:
          "Open a contact and see everything that's happened with them so far — no digging through five tabs before a call.",
        proof: { stat: "< 5 sec", label: "to full contact context" },
      },
    ],
    howItWorks: [
      { headline: "A contact is created or enriched", description: "Records start from a form, an import, or enrichment." },
      { headline: "Every touchpoint attaches automatically", description: "Deals, emails, calls, campaigns, and tickets link to the record." },
      { headline: "The timeline builds itself", description: "No manual logging — activity across every module lands in order." },
      { headline: "Any team opens full context instantly", description: "Sales, marketing, and support see the same complete history." },
    ],
    comparison: {
      title: "Contact 360 vs. scattered records",
      statusQuo:
        "A contact's history is split across an inbox, a support tool, and a spreadsheet — nobody sees the full picture at once.",
      withZynReach:
        "Every touchpoint lands on one record automatically, so any team can see the full relationship in seconds.",
    },
    relatedIntegrations: ["CRM Data", "Support & Helpdesk", "Email & Calendar", "Call Recording"],
    seoKeywordCluster: "360 customer view, unified contact record software",
  },
  {
    slug: "business-data",
    navLabel: "Business Data",
    meta: {
      h1: "The data layer behind every list",
      title: "ZynReach Business Data",
      description:
        "Discover prospects, extract verified contact and company data, and build targeted lists.",
    },
    hero: {
      headline: "The data layer behind every list",
      subhead:
        "Discover prospects, extract verified contact and company data, and build targeted lists — the foundation Lead Generation runs on.",
    },
    whoItsFor: [
      { label: "Sales Teams", href: "/solutions/sales" },
      { label: "Marketing Teams", href: "/solutions/marketing" },
    ...
    featureBlocks: [
      {
        headline: "Prospect discovery",
        description:
          "Search and filter by firmographic and technographic criteria to find the companies and contacts that match your ideal customer profile.",
        proof: { stat: "Millions", label: "of searchable companies & contacts" },
      },
      {
        headline: "Verified data extraction",
        description:
          "Pull verified emails, phone numbers, and job titles, so outreach doesn't bounce or land with the wrong person.",
        proof: { stat: "95%+", label: "verified data accuracy" },
      },
      {
        headline: "Automatic enrichment",
        description:
          "Existing contacts and companies get appended with firmographic data automatically as records enter the system.",
        proof: { stat: "0 clicks", label: "to enrich a record" },
      },
      {
        headline: "Targeted list building",
        description:
          "Build and export lists filtered by segment, industry, size, or intent — ready to push straight into a campaign or pipeline.",
        proof: { stat: "Minutes", label: "to build a targeted list" },
      },
    ],
    howItWorks: [
      { headline: "Define your target criteria", description: "Set firmographic, technographic, or intent filters." },
      { headline: "Search and discover matching prospects", description: "Results pull from a continuously updated data set." },
      { headline: "Data is verified and enriched", description: "Contact and company details are checked and filled in automatically." },
      { headline: "Export or push into your pipeline", description: "Send the list straight into Business Data, campaigns, or CRM." },
    ],
    comparison: {
      title: "Business Data vs. manual prospecting",
      statusQuo:
        "Lists get built by hand from scattered sources, going stale within weeks and full of unverified contact details.",
      withZynReach:
        "Verified, enriched lists build in minutes from continuously updated data — ready to work immediately.",
    },
    relatedIntegrations: ["CRM Data", "Developer & API", "Analytics & BI"],
    seoKeywordCluster: "B2B data enrichment, prospect list building software",
  },
  {
    slug: "ai-workspace",
