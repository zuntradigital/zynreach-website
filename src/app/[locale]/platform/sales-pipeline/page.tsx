...
const raw = productExperiencePages.find((page) => page.slug === "sales-pipeline")!;
const routePath = "/platform/sales-pipeline";
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const t = await getTranslations({ locale, namespace: "productPages.sales-pipeline" });
...
export default async function SalesPipelinePage({ params }: PageProps) {
  ...
  const t = await getTranslations("productPages.sales-pipeline");
