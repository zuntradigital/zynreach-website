...
const raw = productExperiencePages.find((page) => page.slug === "crm")!;
const routePath = "/platform/crm";
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const t = await getTranslations({ locale, namespace: "productPages.crm" });
...
export default async function CrmPage({ params }: PageProps) {
  ...
  const t = await getTranslations("productPages.crm");
