...
const raw = productExperiencePages.find((page) => page.slug === "lead-generation")!;
const routePath = "/platform/lead-generation";
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const t = await getTranslations({ locale, namespace: "productPages.lead-generation" });
...
export default async function LeadGenerationPage({ params }: PageProps) {
  ...
  const t = await getTranslations("productPages.lead-generation");
