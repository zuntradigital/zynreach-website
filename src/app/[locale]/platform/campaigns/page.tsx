...
const raw = productExperiencePages.find((page) => page.slug === "campaigns")!;
const routePath = "/platform/campaigns";
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const t = await getTranslations({ locale, namespace: "productPages.campaigns" });
...
export default async function CampaignsPage({ params }: PageProps) {
  ...
  const t = await getTranslations("productPages.campaigns");
